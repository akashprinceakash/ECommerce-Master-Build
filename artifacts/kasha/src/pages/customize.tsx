...
const LOGO_POSITIONS: Record<string, { left:number; top:number }> = {
  ...
  "left-sleeve":   { left: 816, top: 130 },  // rightSleeve UV zone → appears on left sleeve (UV is horizontally mirrored)
  "right-sleeve":  { left: 409, top: 120 },  // leftSleeve UV zone → mirror of left-sleeve (1024−816=208)
