...
export const PATTERNS: PatternDef[] = [
  ...
  // kasha.png — the GT015 source image. Used when admin sets product type="print"
  // and pattern="kasha-gt015". For type="pattern" the pre-rendered base64 in
  // gt-styles.ts is used instead (supports live pixel-swap recoloring).
  { id: "kasha-gt015",     label: "Kasha GT015",      file: "kasha.png",           swatchColors: ["#000000", "#F0CED2"] },
];
